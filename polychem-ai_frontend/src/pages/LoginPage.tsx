...
function LoginPage() {
  ...
  return (
    // FIX 1: Gunakan warna background eksplisit (bg-slate-900) agar konsisten dengan DashboardLayout
    <div className="min-h-screen flex bg-white dark:bg-slate-900 transition-colors duration-300">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 py-12 sm:px-12 lg:px-16 xl:px-24">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  type="email"
                  required
                  className="appearance-none block w-full px-3 py-3 border border-gray-300 dark:border-slate-700 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white placeholder-gray-400"
                  value={email}
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link to="/forgot-password" className="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500 hover:underline">
                    Lupa password?
                  </Link>
                </div>
              </div>
              <div className="mt-1">
                <input
                  ...
                  type="password"
                  required
                  className="appearance-none block w-full px-3 py-3 border border-gray-300 dark:border-slate-700 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white"
                  value={password}
          ...
          {/* --- BAGIAN DIVIDER YANG DIPERBAIKI --- */}
          <div className="mt-6">
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                {/* FIX 2: Warna garis diredupkan di dark mode (slate-700) */}
                <div className="w-full border-t border-gray-300 dark:border-slate-700" />
              </div>
              <div className="relative flex justify-center text-sm">
                {/* FIX 3: Background text DISAMAKAN dengan background halaman (bg-slate-900) */}
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              <button
                ...
                type="button"
                className="w-full inline-flex justify-center items-center py-3 px-4 border border-gray-300 dark:border-slate-700 rounded-lg shadow-sm bg-white dark:bg-slate-800 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors"
              >
