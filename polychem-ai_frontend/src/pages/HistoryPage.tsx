...
function HistoryPage() {
  ...
  const handleItemClick = (item: HistoryItem) => {
    try {
      ...
      if (!predictionData) {
        alert("Data history tidak kompatibel dengan format terbaru.");
        return;
      }
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <svg
                    ...
                    strokeWidth={2}
                    stroke="currentColor"
                    className="w-4 h-4 text-gray-300 dark:text-slate-600 group-hover:text-blue-600 dark:group-hover:text-blue-400"
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
