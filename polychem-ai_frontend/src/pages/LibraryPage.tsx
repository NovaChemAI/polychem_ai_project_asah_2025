      ...
      <div className="max-w-7xl mx-auto px-4 py-8 animate-pulse">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div
              key={i}
              className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-6 h-64 flex flex-col justify-between"
            >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-sm border border-gray-200 dark:border-slate-700 transform transition-all scale-100 p-6">
            ...
            <p className="text-gray-500 dark:text-slate-400 mb-6">
              Tindakan ini tidak dapat dibatalkan. Item akan dihapus permanen
              dari library Anda.
            </p>
      ...
      <div className="mb-8 flex justify-between items-end">
        <div>
          ...
          <p className="text-gray-600 dark:text-slate-400">
            Koleksi senyawa dan hasil AI yang tersimpan
          </p>
        </div>
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    <div className="relative">
                      {imageSrc ? (
                        <img
                          ...
                          onError={(e) => {
                            ...
                            (
                              e.target as HTMLImageElement
                            ).nextElementSibling?.classList.add("inline-flex");
                          }}
                        />
                      ) : (
                      ...
                      <div className="hidden items-center justify-center w-16 h-16 rounded-lg bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 font-bold text-2xl absolute top-0 left-0 border border-blue-100 dark:border-blue-800">
                        {item.name ? item.name.charAt(0).toUpperCase() : "?"}
                      </div>
                  ...
                  <p
                    className="text-xs text-gray-500 dark:text-slate-400 font-mono bg-gray-50 dark:bg-slate-900/50 border border-gray-100 dark:border-slate-700 p-2 rounded truncate mb-3"
                    title={item.smiles}
                  >
                    {item.smiles}
                  </p>
